...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Room.always_display'
        db.add_column('base_room', 'always_display', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Room.always_display'
        db.delete_column('base_room', 'always_display')
