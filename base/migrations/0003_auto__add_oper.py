...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Oper'
        db.create_table('ircd_opers', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('username', self.gf('django.db.models.fields.CharField')(unique=True, max_length=31)),
            ...
            ('type', self.gf('django.db.models.fields.CharField')(default='GlobalOp', max_length=20)),
        ))
        db.send_create_signal('base', ['Oper'])


    def backwards(self, orm):
        
        # Deleting model 'Oper'
        db.delete_table('ircd_opers')
    ...
    models = {
        ...
        'base.ircauth': {
            ...
            'username': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '31', 'db_index': 'True'})
        },
        'base.oper': {
            ...
            'username': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '31'})
        },
        'base.room': {
